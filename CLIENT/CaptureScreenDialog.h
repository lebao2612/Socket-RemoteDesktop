...
public:
    CaptureScreenDialog(QWidget* parent = nullptr) : QDialog(parent)
    {
        ...
        //connect(captureScreenButton, &QPushButton::clicked, this, &CaptureScreenDialog::onCaptureScreenClicked);

        //// Tạo nút "Chat"
        //QPushButton* chatButton = new QPushButton("Chat", this);
        //connect(chatButton, &QPushButton::clicked, this, &CaptureScreenDialog::onChatClicked);
